...
/// **Note**: the maximum depth for these comparisons is 1! This means that
/// the comparison will fail when a sub collection in the collections to be
/// compared contains another collection.
/// For example, if you want to compare a list containing a list containing
/// another list, [DeepCollectionEquality] will not be able to
/// deeply compare the nested lists.
///
